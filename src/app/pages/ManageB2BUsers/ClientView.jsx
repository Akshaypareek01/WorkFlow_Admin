...
export const ClientView = () => {
  ...
  const [formDataTrainer, setFormDatasetFormData] = useState(null);
  ...
  const handelTrainerUpdate = () => {
    ...
    axios
      .put(`${Base_url}api/client/${id}`, formDataTrainer)
      .then((response) => {
  ...
  const fetchClientById = async (id) => {
    try {
      const response = await axios.get(`${Base_url}api/client/${id}`); // Replace with your actual API endpoint
  ...
  return (
    <div style={{ display: "flex", backgroundColor: "#fff" }}>
      ...
      >
        {
          formDataTrainer && <div style={{ height: "100%" }}>
